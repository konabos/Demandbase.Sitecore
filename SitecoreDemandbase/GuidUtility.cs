//   Helper for guids, found here https://github.com/LogosBible/Logos.Utility/blob/master/src/Logos.Utility/GuidUtility.cs
...
namespace SitecoreDemandbase
{
	...
	public static class GuidUtility
	{
		...
		/// The <see cref="ID"/>.
		/// </returns>
		public static ID GetId(string prefix, string key)
		{
			return new ID(Create(DemandbaseConstants.IdGenerationGuid, prefix + key));
		}
